...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      ...
      {
        image: `./images/tinintinan.png`,
        text: "Tinintinan Beach",
      },
      {
        image: `./images/island6.jpg`,
        text: "Maraquit Island",
      },
      {
        image: `./images/island7.jpg`,
        text: "Mantulali Island",
      },
      {
        image: `./images/bayan.jpg`,
        text: "Poblacion Araceli",
      },
    ];
